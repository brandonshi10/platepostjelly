...
/**
 * Transitional v1 JellyHunt tables.
 *
 * Existing v1 routes and Convex functions still compile against these names.
 * Keep them beside the namespaced v2 tables until the signed v1 retirement
 * watermark and data-plane fence permit their removal.
 */
export const legacyJellyhuntTables = {
